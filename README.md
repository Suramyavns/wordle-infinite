...
👉 **[Download Infinite Wordle APK](https://github.com/Suramyavns/wordle-infinite/releases/tag/android)**

### Build from Source

1. **Clone the Repo**:
   ```bash
   git clone https://github.com/Suramyavns/wordle-infinite.git
   ```
2. **Setup Firebase**:
